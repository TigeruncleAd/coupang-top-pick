      ...
      <div className="mx-auto flex max-w-2xl flex-col gap-12 px-6">
        ...
        <Accordion type="single" defaultValue="item-1" aria-label="FAQ items">
          ...
          <AccordionItem value="item-1">
            <AccordionTrigger className="text-left text-base font-medium">What is shadcn/ui?</AccordionTrigger>
            <AccordionContent className="text-muted-foreground text-sm">
              Shadcn/ui is a popular, open-source UI component library for React that focuses on flexibility and
              customization. It provides a set of accessible, customizable components that you can use to build modern
              web applications.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent className="text-muted-foreground text-sm">
              The shadcn/ui kit for Figma is a comprehensive design resource that mirrors the components and styling of
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent className="text-muted-foreground text-sm">
              Yes, you can still use this kit even if you're new to shadcn/ui. The components are designed to be
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent className="text-muted-foreground text-sm">
              Yes, the UI kit is designed to be flexible and can be customized for multiple brands and design systems.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-5">
            ...
            <AccordionContent className="text-muted-foreground text-sm">
              This kit provides pre-built components and consistent styling, reducing development and design time
              significantly.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-6">
            ...
            <AccordionContent className="text-muted-foreground text-sm">
              The kit provides a shared language and consistent components that both designers and developers can
              reference.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
