...
export function SignIn5() {
  return (
    <div className="bg-background md:flex md:min-h-screen">
      ...
      <div className="bg-destructive bg-primary hidden min-h-full w-[40%] flex-col-reverse p-12 md:flex">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-background text-muted-foreground px-2 uppercase">or sign in with</span>
              </div>
            </div>
