  ...
  return (
    <div className="md:bg-muted flex items-center justify-center bg-cover md:min-h-screen">
      <div className="flex h-screen w-full flex-col md:h-auto md:max-w-[440px] md:px-4 md:py-6">
        <Card className="w-full rounded-none border-none shadow-none md:rounded-lg md:border md:shadow-md">
          <div className="mx-auto max-w-sm md:w-full md:max-w-full">
            {/* Card Header: Logo, Title, and Description */}
            <CardHeader className="flex flex-col items-center text-center">
              <Logo className="mb-6" />
              <CardTitle className="font-bold md:text-3xl">Sign in</CardTitle>
            ...
            <CardContent>
              ...
              <div className="flex w-full gap-x-2">
                ...
                <Button variant="outline" className="text-foreground w-full space-x-2">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="relative my-6 w-full">
                <div className="text-muted-foreground bg-background absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform px-2 text-xs uppercase">
                  Or
                </div>
                <Separator />
              </div>
            ...
            <CardFooter className="md:bg-muted flex w-full items-center justify-center md:rounded-bl-lg md:rounded-br-lg md:border-t md:p-6 ">
        ...
        <div className="text-muted-foreground bg-muted flex w-full flex-col gap-y-4 py-6 text-center text-sm md:flex-row md:justify-between md:bg-transparent">
