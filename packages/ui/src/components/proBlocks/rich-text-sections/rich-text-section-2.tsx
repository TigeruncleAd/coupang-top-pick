...
export function RichTextSection2() {
  return (
    <section className="bg-background py-16 md:py-24" aria-labelledby="article-title">
        ...
        <article className="flex flex-col gap-12 md:gap-16">
          <div className="flex max-w-3xl flex-col gap-8">
            <div className="flex flex-col gap-4 md:gap-5">
              ...
              <h1 id="article-title" className="text-4xl font-bold leading-tight lg:text-5xl">
            ...
            <div className="flex items-center gap-4" aria-label="Article author">
          ...
          <div className="flex max-w-3xl flex-col gap-6">
            ...
            <h2 className="border-b pb-2 text-3xl font-semibold" id="the-kings-plan">
              The King's Plan
            </h2>
            ...
            <ul className="ml-6 list-disc space-y-2" aria-label="Joke tax rates">
            ...
            <h3 className="mt-8 text-2xl font-semibold" id="the-peoples-rebellion">
