      ...
      <div className="container mx-auto flex flex-col gap-4 px-4 py-4 md:gap-6 md:py-6 lg:px-6">
        ...
        <Card>
          <CardHeader className="flex flex-col items-start justify-between gap-2 sm:flex-row sm:items-center">
            <div>
              <CardTitle className="text-xl font-semibold">Public API Settings</CardTitle>
              <CardDescription>Manage and configure access to the Public API.</CardDescription>
            </div>
            <Button>
              <Plus />
              New
              ...
              <Table className="min-w-[480px]">
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="hidden font-medium sm:table-cell">Date of Creation</TableHead>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell className="hidden sm:table-cell">Sep 6, 2024 2:08 am</TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Product Info API</TableCell>
                    <TableCell className="hidden sm:table-cell">Sep 12, 2024 2:07 pm</TableCell>
                    <TableCell>
                      <Badge className="bg-primary">Active</Badge>
                    </TableCell>
                    <TableCell className="flex justify-end">
                  ...
                  <TableRow>
                    ...
                    <TableCell className="hidden sm:table-cell">Aug 20, 2024 7:59 am</TableCell>
                    <TableCell>
        ...
        <Card>
          <CardHeader className="flex flex-col items-start justify-between sm:flex-row sm:items-center">
            <div>
              <CardTitle className="text-xl font-semibold">Private API Settings</CardTitle>
              <CardDescription>Manage and configure access to the Private API.</CardDescription>
            </div>
            <Button>
              <Plus />
              New
          ...
          <CardContent>
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className="font-medium">Internal Data API</TableCell>
                    <TableCell className="hidden sm:table-cell">Sep 1, 2024 7:53 pm</TableCell>
                    <TableCell>
                      <Badge className="bg-primary">Active</Badge>
                    </TableCell>
                    <TableCell className="flex justify-end">
                  ...
                  <TableRow>
                    <TableCell className="font-medium">Auth Service API</TableCell>
                    <TableCell className="hidden sm:table-cell">Aug 29, 2024 9:18 pm</TableCell>
                    <TableCell>
                      <Badge className="bg-primary">Active</Badge>
                    </TableCell>
                    <TableCell className="flex justify-end">
                  ...
                  <TableRow>
                    ...
                    <TableCell className="hidden sm:table-cell">Aug 19, 2024 8:51 pm</TableCell>
                    <TableCell>
