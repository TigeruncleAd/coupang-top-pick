        ...
        <div className="flex flex-col md:flex-row">
          ...
          <main className="flex-1 py-4 md:py-6">
            <Card className="bg-primary text-primary-foreground mb-4">
              <CardContent className="flex flex-col items-start justify-between p-4 md:flex-row md:items-center md:p-6">
            ...
            <Card className="mb-4">
              <CardHeader className="px-4 pb-0 pt-4 md:px-6 md:pt-6">
                ...
                <p className="text-muted-foreground text-sm">View and update your card details here.</p>
              </CardHeader>
              ...
              <CardFooter className="flex justify-end border-t px-4 py-4 md:px-6">
                <Button>Save</Button>
              </CardFooter>
            </Card>
            ...
            <Card>
              <CardHeader className="px-4 pb-0 pt-4 md:px-6 md:pt-6">
                ...
                <p className="text-muted-foreground text-sm">Update personal information.</p>
              </CardHeader>
              <CardContent className="p-4 md:p-6">
                <form className="space-y-4">
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="emailAddress" type="email" value="kathy_pacheco@mail.com" />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="streetAddress" value="2825 Winding Way, Providence, RI 02908" />
                    </div>
                    <div className="space-y-2">
