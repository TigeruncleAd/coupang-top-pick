...
import { Table, TableCell, TableHead, TableHeader, TableRow } from '@repo/ui/components/table'
...
export function Navbar2() {
  ...
  const NavItems = ({ isMobile = false }) => {
    const linkClasses = `font-medium ${isMobile ? 'text-base' : 'text-sm'} ${
      isMobile ? 'text-muted-foreground' : 'text-muted-foreground hover:bg-muted/50'
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <aside className="hidden w-64 py-6 md:block">
              <ul className="-ml-3 space-y-1">
                <li className="hover:bg-accent-foreground/10 text-muted-foreground cursor-pointer rounded-md px-3 py-2 text-sm font-medium">
                  <a>Profile</a>
                </li>
                <li className="hover:bg-accent-foreground/10 bg-accent-foreground/5 text-accent-foreground cursor-pointer rounded-md px-3 py-2 text-sm font-medium">
                  <a>Account</a>
                </li>
                <li className="hover:bg-accent-foreground/10 text-muted-foreground cursor-pointer rounded-md px-3 py-2 text-sm font-medium">
                  <a>Members</a>
              ...
              <div className="container mx-auto px-0 py-4 md:py-6 md:pl-6">
                <div className="flex flex-col gap-4 md:gap-6">
                  ...
                  <Card className="border-border rounded-lg border shadow-sm">
                    ...
                    <div className="flex items-start gap-4 px-4 pb-6 md:px-6">
                    ...
                    <div className="flex items-center justify-start border-t px-4 py-4 md:justify-end md:px-6">
                      <Button>Save</Button>
                    </div>
                  </Card>
                  ...
                  <Card className="border-border rounded-lg border shadow-sm">
                    <div className="px-4 py-4 md:px-6">
                      <div className="space-y-1">
                        <h2 className="text-lg font-semibold md:text-xl">Display name</h2>
                        <p className="text-muted-foreground text-sm">
                    ...
                    <div className="flex flex-col items-start justify-between gap-3 border-t px-4 py-4 md:flex-row md:items-center md:px-6">
                      <p className="text-muted-foreground text-sm">Maximum allowed length is 32 characters.</p>
                      <Button>Save</Button>
                    </div>
                  </Card>
                  ...
                  <Card className="border-border rounded-lg border shadow-sm">
                    <div className="p-4 md:p-6">
                      <div className="space-y-1">
                        <h2 className="text-lg font-semibold md:text-xl">Teams</h2>
                        <p className="text-muted-foreground text-sm">Here is your URL namespace for use in our app.</p>
                      </div>
                    </div>
                    <div className="px-4 pb-4 md:px-6">
                      <Table className="w-full min-w-[480px]">
                        ...
                        <TableRow>
                          <TableCell className="font-medium">Shadcn Design Team</TableCell>
                        ...
                        <TableRow>
                          <TableCell className="font-medium">Vercel Team</TableCell>
                        ...
                        <TableRow>
                          <TableCell className="font-medium">Figma Team</TableCell>
                        ...
                        <TableRow>
                          <TableCell className="font-medium">Next JS Team</TableCell>
                    ...
                    <div className="flex flex-col items-start justify-end gap-3 border-t px-4 py-4 md:flex-row md:items-center md:px-6">
                  ...
                  {/* Delete Account Card */}
                  <Card className="border-destructive rounded-lg border shadow-sm">
                    <div className="p-4 md:p-6">
                      <div className="space-y-1">
                    ...
                    <div className="bg-destructive/10 flex flex-col items-start justify-between gap-3 border-t px-4 py-4 md:flex-row md:items-center md:px-6">
