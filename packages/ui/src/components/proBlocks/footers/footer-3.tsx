      ...
      <div className="container mx-auto flex flex-col gap-12 px-6 lg:gap-16">
        ...
        <div className="relative flex flex-col items-center gap-12 md:items-center md:justify-between lg:flex-row lg:gap-8">
          ...
          <div className="flex justify-center gap-4 md:gap-6" aria-label="Social media links">
            <Link href="#" className="transition-all duration-300 hover:scale-110" aria-label="Follow us on Facebook">
            ...
            <Link href="#" className="transition-all duration-300 hover:scale-110" aria-label="Follow us on Instagram">
              <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="currentColor"
            ...
            <Link href="#" className="transition-all duration-300 hover:scale-110" aria-label="Follow us on Twitter">
              <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="currentColor"
            ...
            <Link href="#" className="transition-all duration-300 hover:scale-110" aria-label="Follow us on YouTube">
              <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="currentColor"
            ...
            <Link href="#" className="transition-all duration-300 hover:scale-110" aria-label="Contact us on WhatsApp">
              <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="currentColor"
