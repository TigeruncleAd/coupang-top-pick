    ...
    <div className="bg-background">
      ...
      <div className="container mx-auto px-4 py-6 lg:px-6">
        <div className="border-border flex w-full flex-col items-center gap-6 rounded-md border border-dashed p-6 text-center">
          <div className="bg-card text-card-foreground border-border flex h-12 w-12 items-center justify-center rounded-md border shadow-sm">
            <Inbox className="h-6 w-6" />
          </div>
          <div className="space-y-2">
            <h1 className="text-lg font-semibold md:text-xl">No databases added</h1>
            <p className="text-muted-foreground text-sm">
              Read and write directly to databases and stores from your projects.
            </p>
          </div>
