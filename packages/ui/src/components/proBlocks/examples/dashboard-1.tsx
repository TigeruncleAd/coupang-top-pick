...
import { Search, Plus, ChevronDown, Download, MoreHorizontal } from 'lucide-react'
...
import { Home, Store, Mail, Users, Settings2, GalleryVerticalEnd } from 'lucide-react'
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
                            ...
                            <TableRow key={row.id}>
                              ...
                              <TableCell>
                                <Badge
                                  ...
                                  className={
                                    row.status === 'Paid' ? 'bg-green-600/10 text-green-600 hover:bg-green-50/80' : ''
                                  }>
                                  {row.status}
                                </Badge>
                              </TableCell>
