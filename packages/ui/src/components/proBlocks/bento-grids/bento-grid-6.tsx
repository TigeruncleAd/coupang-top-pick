    ...
    <section className="bg-background py-16 md:py-24">
      <div className="container mx-auto flex flex-col gap-12 px-6">
        ...
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-3 lg:grid-rows-2">
          ...
          <Card className="bg-muted/80 overflow-hidden rounded-xl border-none shadow-none lg:col-span-2">
            <Image src="https://ui.shadcn.com/placeholder.svg" alt="Placeholder" className="h-80 w-full object-cover" />
            <CardContent className="flex flex-col gap-6 p-6 md:p-8">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  features. Make sure to keep the description concise and to the point.
                </p>
              </div>
            </CardContent>
          </Card>
          {/* Regular Feature Card - Top Right */}
          <Card className="bg-muted/80 overflow-hidden rounded-xl border-none shadow-none lg:col-span-1">
            <Image src="https://ui.shadcn.com/placeholder.svg" alt="Placeholder" className="h-80 w-full object-cover" />
            <CardContent className="flex flex-col gap-6 p-6 md:p-8">
              <div className="space-y-2">
                <h3 className="text-foreground text-lg font-semibold">Feature title</h3>
