...
export function PricingSection1() {
  ...
  return (
    ...
    <section className="bg-background py-16 md:py-24" aria-labelledby="pricing-section-title">
                ...
                <CardContent className="flex flex-col gap-8 p-0">
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="relative flex flex-col gap-3">
                      {/* Popular Plan Badge */}
                      {plan.badge && <Badge className="absolute right-0 top-1 w-fit">{plan.badge}</Badge>}
