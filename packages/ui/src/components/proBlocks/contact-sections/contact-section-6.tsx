...
export function ContactSection6() {
  ...
  return (
    <section
      ...
      {/* Left Column */}
      <div className="flex-1 items-center justify-center px-6 md:p-0 md:py-24">
        <div className="mx-auto flex max-w-md flex-col gap-10">
          ...
          <form className="flex flex-col gap-5 md:gap-6" onSubmit={e => e.preventDefault()} aria-label="Contact form">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="message" placeholder="Type your message" required aria-required="true" />
            </div>
            ...
            <div className="flex items-center gap-2">
              <Checkbox
                ...
                aria-required="true"
              />
              <Label htmlFor="privacy" className="text-muted-foreground text-sm font-normal leading-none">
        ...
        <div className="mx-auto flex max-w-md flex-col gap-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-foreground text-lg font-bold">Visit our offices</h2>
              <p className="text-muted-foreground text-base">
            ...
            <div className="flex flex-col gap-6 md:flex-row">
              ...
              <div className="flex flex-1 flex-col gap-2">
                <h3 className="text-card-foreground text-base font-semibold">New Mexico</h3>
              ...
              {/* Hawaii Office */}
              <div className="flex flex-1 flex-col gap-2">
                <h3 className="text-card-foreground text-base font-semibold">Hawaii</h3>
                <p className="text-muted-foreground whitespace-pre-line text-base">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6 md:flex-row">
              {/* Sales Email */}
              <div className="flex flex-1 flex-col gap-2">
                <h3 className="text-card-foreground text-base font-semibold">Sales</h3>
                <Link href="mailto:sales@example.com" className="text-muted-foreground text-base underline">
                  sales@example.com
                </Link>
              </div>
              ...
              {/* Careers Email */}
              <div className="flex flex-1 flex-col gap-2">
                <h3 className="text-card-foreground text-base font-semibold">Careers</h3>
                <Link href="mailto:careers@example.com" className="text-muted-foreground text-base underline">
                  careers@example.com
                </Link>
              </div>
            </div>
