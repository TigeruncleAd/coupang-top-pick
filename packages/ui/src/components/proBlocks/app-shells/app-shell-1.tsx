    ...
    return (
      <>
        ...
        <Link href="#" className={`${linkClasses} flex gap-2`}>
          Orders
          <Badge className="flex h-5 w-5 items-center justify-center p-0 text-xs">2</Badge>
        </Link>
        ...
        {isMobile ? (
          <div>
            <button
              ...
              Settings
              <ChevronDown className={`h-5 w-5 transition-transform ${isSettingsOpen ? 'rotate-180 transform' : ''}`} />
            </button>
            {isSettingsOpen && (
              <div className="ml-3 mt-1 space-y-1">
                <Link href="#" className="text-muted-foreground block rounded-md px-3 py-2 text-base font-medium">
                  General
                </Link>
                <Link href="#" className="text-muted-foreground block rounded-md px-3 py-2 text-base font-medium">
                  Security
