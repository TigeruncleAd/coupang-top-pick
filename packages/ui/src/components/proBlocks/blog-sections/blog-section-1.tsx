...
export function BlogSection1() {
  return (
    <section className="bg-background py-16 md:py-24" aria-labelledby="blog-section-heading">
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center gap-8 md:gap-12">
          ...
          <div className="flex max-w-xl flex-col items-center gap-4 text-center md:gap-5">
            ...
            {/* Main Title */}
            <h2 id="blog-section-heading" className="text-3xl font-bold leading-tight md:text-4xl">
              ...
              <Link href="#" key={post.id} className="group block">
                ...
                <div className="flex flex-col gap-4 rounded-xl transition-all duration-200">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    {/* Post Title */}
                    <h3 className="text-base font-semibold leading-normal group-hover:underline">{post.title}</h3>
